              ...
              <div class="row justify-content-between">
                ...
                <div class="col-auto">
                  <div class="user-group mb-3">
                    <img src="../../src/assets/images/user/avatar-1.jpg" alt="image"/>
                    <img src="../../src/assets/images/user/avatar-2.jpg" alt="image"/>
                    <img src="../../src/assets/images/user/avatar-3.jpg" alt="image"/>
                  </div>
                </div>
              </div>
              <div class="d-grid">
              ...
              <div class="col-md-6">
                <div class="card-body bg-primary position-relative h-100">
                  ...
                  <div class="row align-items-end">
                    ...
                    <div class="col-5">
                      <img src="../../src/assets/images/widget/reader.svg" alt="img" class="img-fluid img-reader"/>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="d-flex align-items-center">
                <div class="flex-shrink-0">
                  <img src="../../src/assets/images/widget/target.svg" alt="img" class="img-fluid"/>
                </div>
                <div class="flex-grow-1 ms-3">
