...
import { clearMessages, UpdateUserProfile } from '../redux/slice/authSlice';
                  ...
                  <div class="row">
                    <div class="text-center mb-3">
                      <div class="chat-avtar d-inline-flex mx-auto">
                        <img class="rounded-circle img-fluid wid-70"  src={updateInfo.preview || "../src/assets/images/user/avatar-5.jpg"}
                          alt="User image" />
                      </div>
                      <div class="col-auto">
